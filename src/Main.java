...
public class Main {
    public static void main(String[] args) {
        ...
        Cliente cliente = new Cliente("12345678910", "Maria", "11999999999");
        Vendedor vendedor = new Vendedor("10987654321", "Maurício", "001");
        ...
        Compra compra = new Compra(cliente, vendedor, "0001", LocalDate.now());
